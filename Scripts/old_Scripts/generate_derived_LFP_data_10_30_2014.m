...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\10_30_2014_per30con.mat';
% save(filename, 'con' ) ;
...
% 30uM CAR
car.filepath={file1, file2, file3, file4, file5, file6,file7,file8} ;
bands_needed=[1 4 8 14 30 50];
nbands = length( bands_needed) - 1 ;

for curFile=6:length(car.filepath)
...
% f(index_freq) becomes actual 
 ...
 % get power for specific bands
f_temp = cell(1,5) ;
for band=6:length(bands_needed)-1
  % for each band get the corresponding frequencies
  index_freq = ( f >=bands_needed(band)& f <=bands_needed(band+1) ) ;
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\10_30_2014_car30.mat';
% save(filename, 'car' ) ;
...
for curFile=6:length(con.filepath)
    for ent = 1:60
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\11_05_2014_carcon.mat';
% save(filename, 'con' ) ;
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\10_30_2014_h20.mat';
% save(filename, 'h20' ) ;
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\10_30_2014_conh20.mat';
% save(filename, 'con' ) ;
...
ace.filepath = {file1, file2, file3, file4,file5, file6 }  ;
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\10_30_2014_ace.mat';
% save(filename, 'ace' ) ;
...
% filename='F:\EXTRAP\matlab_Cina_Herr_Diana\finshed_data\11_04_2014_conace.mat';
% save(filename, 'con' ) ;
